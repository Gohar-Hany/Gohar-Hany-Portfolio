...
export const galleryItems: GalleryItem[] = [
  {
    ...
    title: "iCode Project Opening Ceremony",
    description: "Opening ceremony for the iCode project with the iCode Family community; I served as a co-founder and helped lead the launch.",
    date: "2023",
    location: "Alexandria - Faculty of Science",
    type: "Conference",
    featured: true
  },
  {
    ...
    title: "GA Talk",
    description: "Delivered a GA talk in my role as Head of PR, focused on communication and outreach.",
    date: "2022",
    location: "Alexandria",
    type: "Presentation",
    featured: true
  },
  {
    ...
    title: "Enactus Alex x Jobzella Event (Job Fair)",
    description: "Job fair with the organizing team and media crew supporting the ALEX x Jobzella initiative.",
    date: "2025",
    location: "Alexandria",
    type: "Networking"
  },
  {
    ...
    title: "Tech Meetup",
    description: "Tech meetup where I met Eng. Ahmed Abu Zaid, founder of the Dros Online channel.",
    date: "2023",
    location: "Alexandria - Tulip Hotel",
    type: "Networking"
  },
  {
    id: 5,
